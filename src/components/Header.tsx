        ...
        <div className="flex items-center justify-between gap-4">
          ...
          >
            <div className="relative">
              ...
              <div
                className={`absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full border-2 border-zinc-900 ${
                  isOfflineOrError ? 'bg-zinc-500' : 'bg-red-500'
                }`}
              />
            </div>
            <div className="min-w-0 flex-1">
              ...
              <div
                className="max-w-[280px] sm:max-w-[480px] md:max-w-[560px] overflow-hidden"
                style={{
                  maskImage:
          ...
          <div className="flex items-center gap-3">
            ...
            <div
              className={`px-3 py-1.5 rounded-full text-xs font-medium ${
                isOfflineOrError ? 'bg-zinc-500/10 text-zinc-400' : 'bg-red-500/10 text-red-400'
              }`}
            >
